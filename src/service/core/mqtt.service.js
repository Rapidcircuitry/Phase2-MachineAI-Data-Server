...
export const createMqttService = () => {  
  ...
  const initTopicHandlers = () => {  
    return [  
      {  
        topic: TOPICS.REGISTER.topic,  
        matchingKey: TOPICS.REGISTER.matchingKey,  
        handler: RegistrationHandler.handleDeviceRegistration,  
      },  
      {  
        topic: TOPICS.PONG.topic,  
        matchingKey: TOPICS.PONG.matchingKey,  
        handler: PongHandler.handlePong,  
      },  
      {  
        topic: TOPICS.ACK.topic,  
        matchingKey: TOPICS.ACK.matchingKey,  
        handler: AckHandler.handleAck,  
      },  
      {  
        topic: TOPICS.INPUT_STATES.topic,  
        matchingKey: TOPICS.INPUT_STATES.matchingKey,  
        handler: InputStatesHandler.handleInputStates,  
      },  
    ];  
  };  
